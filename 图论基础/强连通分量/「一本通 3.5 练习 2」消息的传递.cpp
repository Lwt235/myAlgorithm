...
void topologicalSort(const vector<vector<int>>& Edge, int n, vector<int>colorVal, int& planA)
{
...
int main()
{
	...
	int planA = 0;
	topologicalSort(newEdge, col - 1, colorVal, planA);
	printf("%d", planA);
	return 0;
}